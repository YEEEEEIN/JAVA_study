...
import Dao.GongjiReDaoImpl;
import Dto.Pagination;

public class GongjiReServiceImpl implements GongjiReService {

	@Override
	public Pagination getPagination(int page, int countPerpage) { // 구하는 페이지, 페이지당 보여주는 데이터 수 매개변수
		
		GongjiReDaoImpl studentScoreDaoImpl = new GongjiReDaoImpl(); // GongjiDaoImpl의 객체 선언
